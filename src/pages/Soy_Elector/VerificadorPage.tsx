...
import { Shield, AlertCircle, CheckCircle2, Sparkles } from 'lucide-react'
import {
  Card,
  CardContent,
  CardDescription,
        ...
        <div className="mx-auto max-w-3xl space-y-6">
          <Alert>
            ...
            <AlertDescription className="mt-2">
              Lo sentimos, no tenemos información verificada para responder a tu
              pregunta en este momento. Intenta reformular tu pregunta o
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Este verificador compara tu pregunta con nuestra base de datos
                  de información verificada. Siempre revisa las fuentes
